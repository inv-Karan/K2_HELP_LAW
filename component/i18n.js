  ...
  resources: {
    ...
    guj: {
        translations: {
          Introduction: "પરિચય",
          "is an internationalization-framework which offers a complete solution to localize your product from web to mobile and desktop":
            "એક આંતરરાષ્ટ્રીયકરણ-માળખું છે જે તમારા ઉત્પાદનને વેબથી મોબાઇલ અને ડેસ્કટોપ પર સ્થાનીકૃત કરવા માટે સંપૂર્ણ નિરાકરણ આપે છે.",
          "Plugins to detect the user language":
            "વપરાશકર્તા ભાષાને શોધવા માટે પ્લગઇન્સ",
          "Plugins to load translations": "અનુવાદો લોડ કરવા માટે પ્લગઇન્સ",
          "Optionally cache the translations": "વૈકલ્પિક રીતે અનુવાદોને કેશ કરો",
          Advantages: "ફાયદા",
          "Flexibility to use other packages":
